		...
		if currentNumOfHouses[city] > lastCurrentNumOfHouses[city] and isRunningFirstTime then
			if database["settings"]["activMessage"] and database["settings"]["textMessage"] then
				...
				if ip == "185.169.134.83" then
					...
					async_http_request("https://api.telegram.org/bot" .. botTG .. "/sendMessage?chat_id=" .. andreyTG .. "&text=" .. u8(sendTG), "", function (result)

					end)
					async_http_request("https://api.telegram.org/bot" .. botTG .. "/sendMessage?chat_id=" .. tomasTG .. "&text=" .. u8(sendTG), "", function (result)

					end)
					async_http_request("https://api.telegram.org/bot" .. botTG .. "/sendMessage?chat_id=" .. patricioTG .. "&text=" .. u8(sendTG), "", function (result)

					end)
					async_http_request("https://api.telegram.org/bot" .. botTG .. "/sendMessage?chat_id=" .. juniorTG .. "&text=" .. u8(sendTG), "", function (result)
