...
function main()
	...
	sampRegisterChatCommand("tgtest", function(send)
	local send = "Тестик"

		async_http_request("https://api.telegram.org/bot" .. botTG .. "/sendMessage?chat_id=" .. maximTG .. "&text=" .. '\xF0\x9F\x8C\x84 [TRP2]: '..u8(send), "", function (result)

		end)
	end)

				sampRegisterChatCommand("tgsend", function(send)
