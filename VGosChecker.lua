		...
		if currentNumOfHouses[city] > lastCurrentNumOfHouses[city] and isRunningFirstTime then
			if database["settings"]["activMessage"] and database["settings"]["textMessage"] then
				...
				if ip == "185.169.134.83" then
					...
					async_http_request("https://api.telegram.org/bot" .. botTG .. "/sendMessage?chat_id=" .. maximTG .. "&text=" .. url_encode(u8(sendTH)), "", function (result)

					end)
					async_http_request("https://api.telegram.org/bot" .. botTG .. "/sendMessage?chat_id=" .. andreyTG .. "&text=" .. url_encode(u8(sendTH)), "", function (result)

					end)
					async_http_request("https://api.telegram.org/bot" .. botTG .. "/sendMessage?chat_id=" .. tomasTG .. "&text=" .. url_encode(u8(sendTH)), "", function (result)

					end)
					async_http_request("https://api.telegram.org/bot" .. botTG .. "/sendMessage?chat_id=" .. patricioTG .. "&text=" .. url_encode(u8(sendTH)), "", function (result)

					end)
					async_http_request("https://api.telegram.org/bot" .. botTG .. "/sendMessage?chat_id=" .. juniorTG .. "&text=" .. url_encode(u8(sendTH)), "", function (result)
